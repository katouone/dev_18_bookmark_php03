...
//データ登録SQL作成
// 1. SQL文を用意
$stmt = $pdo->prepare("INSERT INTO php03_needs_table(id, name, country, scene, type, content, url, indate, lat, lng)VALUES(NULL, :name, :country, :scene, :type, :content, :url, sysdate(), :lat, :lng)");
