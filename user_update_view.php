...
//データ取得
$stmt = $pdo->prepare("SELECT * FROM php03_user_table WHERE id= ".$id);
$status = $stmt->execute();
  ...
  <div class="jumbotron">
    <fieldset>
      <legend>ユーザー情報登録欄</legend>
        ...
        <label>管理権限：
          <input type="radio" name="kanri_flg" value="0" <?php echo $kanri0; ?>>管理者
          <input type="radio" name="kanri_flg" value="1" <?php echo $kanri1; ?>>スーパー管理者
        </label><br>
        <label>ステータス：
